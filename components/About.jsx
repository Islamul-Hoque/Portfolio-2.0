...
export default function About() {
  ...
  useEffect(() => {
    // Set orbit sizes based on window width
    const updateOrbitSizes = () => {
      const width = window.innerWidth;
      setOrbitSizes({
        orbit1: width < 640 ? 80 : width < 768 ? 95 : 110,
        orbit2: width < 640 ? 130 : width < 768 ? 155 : 190,
        orbit3: width < 640 ? 180 : width < 768 ? 220 : 270,
      });
    };

    updateOrbitSizes();
    window.addEventListener("resize", updateOrbitSizes);
    return () => window.removeEventListener("resize", updateOrbitSizes);
  }, []);
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative h-[360px] sm:h-[420px] md:h-[550px] lg:h-[650px] flex justify-center items-center scale-90 md:scale-100 z-10">
            {/* Background Glow */}
            <div className="absolute w-[320px] h-[320px] sm:w-[420px] sm:h-[420px] md:w-[600px] md:h-[600px] bg-blue-600/5 rounded-full blur-[120px] -z-10 animate-pulse" />

            {/* Orbit 1 - Core Stack */}
            <div
              ref={orbit1Ref}
              className="absolute w-[160px] h-[160px] sm:w-[190px] sm:h-[190px] md:w-[220px] md:h-[220px] border border-white/20 rounded-full z-10 shadow-[0_0_20px_rgba(59,130,246,0.1)]"
            >
              {orbit1.map((url, i) => (
                <div
                  key={i}
                  ...
                  style={{
                    top: "50%",
                    left: "50%",
                    transform: `translate(-50%, -50%) rotate(${i * (360 / orbit1.length)}deg) translate(${orbitSizes.orbit1}px) rotate(-${i * (360 / orbit1.length)}deg)`,
                  }}
                >
            ...
            <div
              ref={orbit2Ref}
              className="absolute w-[260px] h-[260px] sm:w-[310px] sm:h-[310px] md:w-[380px] md:h-[380px] border border-white/20 rounded-full z-10 shadow-[0_0_25px_rgba(59,130,246,0.1)]"
            >
              {orbit2.map((url, i) => (
                <div
                  key={i}
                  ...
                  style={{
                    top: "50%",
                    left: "50%",
                    transform: `translate(-50%, -50%) rotate(${i * (360 / orbit2.length)}deg) translate(${orbitSizes.orbit2}px) rotate(-${i * (360 / orbit2.length)}deg)`,
                  }}
                >
                  <div className="floating-icon w-full h-full p-2.5 bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 flex items-center justify-center group hover:bg-white/20 transition-colors">
                    <img
            ...
            <div
              ref={orbit3Ref}
              className="absolute w-[360px] h-[360px] sm:w-[440px] sm:h-[440px] md:w-[540px] md:h-[540px] border border-white/20 rounded-full z-10 shadow-[0_0_30px_rgba(59,130,246,0.1)]"
            >
              {orbit3.map((url, i) => (
                <div
                  key={i}
                  ...
                  style={{
                    top: "50%",
                    left: "50%",
                    transform: `translate(-50%, -50%) rotate(${i * (360 / orbit3.length)}deg) translate(${orbitSizes.orbit3}px) rotate(-${i * (360 / orbit3.length)}deg)`,
                  }}
                >
                  <div className="floating-icon w-full h-full p-2.5 bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 flex items-center justify-center group hover:bg-white/20 transition-colors">
                    <img
            ...
            <motion.div
              ...
              className="relative z-10 w-16 h-16 md:w-24 md:h-24 bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl flex items-center justify-center shadow-[0_0_50px_rgba(37,99,235,0.3)] border border-white/20 rotate-12"
            >
          ...
          <div className="space-y-12">
            <div className="space-y-6">
              ...
              <h3 className="text-2xl md:text-3xl font-black text-white leading-tight">
                ...
                focused on clean code and real-world products.
              </h3>
              <p className="text-lg text-gray-400 leading-relaxed font-medium">
                ...
                I build scalable, maintainable applications with a strong focus
                on performance and user experience. I care about clean
                architecture, readable code, and shipping products that actually
                solve problems.
              </p>
            </div>
